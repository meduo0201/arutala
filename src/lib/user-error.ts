...
const MAPPINGS: ReadonlyArray<readonly [RegExp, string]> = [
  [/invalid login credentials/i, '账号或密码不正确。'],
  [/invalid credentials/i, '账号或密码不正确。'],
  [/email not confirmed/i, '账号尚未激活，请稍后再试。'],
  [/user already registered/i, '该账号已被注册。'],
  [/already registered/i, '该账号已被注册。'],
  ...
  [/vapid key not configured/i, '尚未配置推送公钥。'],
